...
const MainPage = () => {
    return ( <
        ...
        <
        div className = "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 w-full max-w-5xl" > { /* Python Section */ } <
        ...
        strokeLinejoin = 'round'
        strokeWidth = { 2 }
        d = 'M16 7a4 4 0 01-8 0m8 0a4 4 0 01-8 0m8 0V5a4 4 0 00-8 0v2m8 0v2a4 4 0 01-8 0V7' / > < /svg> <
        /span> <
        ...
        strokeLinejoin = 'round'
        strokeWidth = { 2 }
        d = 'M3 10h1l2 7h13l2-7h1' / > < /svg> <
        /span> <
        p className = "font-extrabold text-xl text-blue-700 text-center mb-1" > DevOps < /p> <
        p className = "font-semibold text-blue-400 text-center mb-2" > Tech < /p> <
        ul className = "list-disc ml-6 mt-2 text-gray-700" >
        <
        li > Docker < /li> <
        li > Jenkins CI / CD < /li> <
        ...
        strokeLinejoin = 'round'
        strokeWidth = { 2 }
        d = 'M12 8c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm0 0V4m0 0C7.582 4 4 7.582 4 12c0 4.418 3.582 8 8 8s8-3.582 8-8c0-4.418-3.582-8-8-8z' / > < /svg> <
        /span> <
