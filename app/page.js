...
export default function Page() {
    return (
        <div className="min-h-screen overflow-y-auto bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 font-sans">
            <div className="container-centered max-w-6xl mx-auto px-4 flex flex-col items-center justify-center py-10">
                ...
                <div className="flex-shrink-0 flex flex-col items-center justify-center card-base w-80 md:w-96 lg:w-[28rem] mb-10">
                    ...
                    <div className="flex gap-3 mt-4 justify-center">
                        <a
                            href="https://www.youtube.com/channel/UCDFpwbMB8Owgk0QRBEchNVw"
                            target="_blank"
                        ...
                        <a
                            href="https://www.instagram.com/sharma_gautam_26/"
                            target="_blank"
                            rel="noopener noreferrer"
                ...
                <div className="card-base w-full max-w-4xl mb-10">
                    ...
                    <p className="text-gray-700 mb-3">
                        I'm a full-stack Python/AI developer with 4+ years of experience building scalable web applications, integrating AI/ML models, and deploying cloud solutions. I specialize in Django, FastAPI, React, and modern DevOps practices.
                    </p>
